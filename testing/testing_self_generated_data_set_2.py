...
df_train.to_csv('data/processed/test/self_generated_data_set_2_train.csv')
df_val.to_csv('data/processed/test/self_generated_data_set_2_val.csv')
df_test.to_csv('data/processed/test/self_generated_data_set_2_test.csv')